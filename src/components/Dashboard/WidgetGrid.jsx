...
export default function WidgetGrid({
  ...
  if (!widgets?.length) {
    return (
      <EmptyGrid editMode={editMode} onAdd={onAdd} message="No widgets configured." />
    )
  }
  ...
  if (!tabs.length) {
    return (
      <EmptyGrid editMode={editMode} onAdd={onAdd} message="No column mappings found. Open Settings to map your columns." />
    )
  }
...
function EditableWidget({ widget, isFirst, isLast, onUpdate, onRemove, onMoveLeft, onMoveRight, children }) {
  return (
